...
public class Demo03BeanScopeInjectUsingConfiguration {
	...
	public static void main(String[] args) {
		// use the spring configuration java class
		AnnotationConfigApplicationContext context = new AnnotationConfigApplicationContext(BeanScanConfigurationUsesComponentScanAnnotation.class);
